package com.jwkj.udpsenderdemo.bean;
...
public class ShakeData {
    ...
    public static class Cmd {
        ...
        public static final int CMD_SHAKE_DEVICE_DEFAULT_PORT_RECEIVE = 9999;//搜索设备的端口号
    }
     ...
     * @return 字节数组
     */
    public static byte[] getShakeDataCastByteArray(ShakeData data) {
